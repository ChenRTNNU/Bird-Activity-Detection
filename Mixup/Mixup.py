...
from Mixup.Evaluate import train, valid, eval_acc, eval_auc
...
def run(iRepeat,savepath):
    ...
    log_file_path = save_folder_final + '/log_Mixup_wav.txt'
    ...
    for epoch in range(start_epoch, epochs):
        ...
        #                                           epochs)
        training_loss,model = train(model, training_loader_ff, optimizer, scheduler, device,epoch, epochs)
        ...
        print(f"valid_f1:{valid_f1},valid_acc:{valid_acc}")
        # print(valid_f1)
