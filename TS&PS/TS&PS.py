...
training_dataset_ff = AudioDataset(training_df1, data_folder1='D:\\DeepLearning\\bird_activity_detection\\audio\\ff1010bird',istrain=1)
valid_dataset_ff = AudioDataset(valid_df1, data_folder1='D:\\DeepLearning\\bird_activity_detection\\audio\\ff1010bird',istrain=0)
test_dataset_ff = AudioDataset(test_df1, data_folder1='D:\\DeepLearning\\bird_activity_detection\\audio\\ff1010bird',istrain=0)

test_dataset_warb = AudioDataset(test_df2, data_folder1='D:\\DeepLearning\\bird_activity_detection\\audio\\warblrb10k',istrain=0)
...
if __name__ == '__main__':
    ...
    log_file_path = save_folder_final + '/log_spec_plus_t250_freq25.txt'
